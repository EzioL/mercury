...
public class MercuryHandler implements Runnable {
    ...
    @Override public void run() {
        ...
        try {
            ...
            MercuryRequest request = new Gson().fromJson(this.request, MercuryRequest.class);
            MercuryPacket mercuryPacket = new MercuryPacket(request.getCommand(), request.getBody());
