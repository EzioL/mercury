...
/**
 * Here be dragons
 * Created by haotian on 2018/11/20 11:59 AM
 */
@Data
public class MercuryPacket extends Packet {
    ...
    public MercuryPacket(int cmd, ByteString requestBody) {
    ...
    public static MercuryPacket build(BufferedSource reader) throws IOException {
